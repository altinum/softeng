...
Excel állományok generálására és olvasására több megközelítés létezik. Az itt bemutatott megoldás hátránya, hogy csak Windows alatt működik, és telepített Excel szükséges hozzá. 

Szükséges könyvtárakon keresztül megnyitható egy Excel példány. Az Excel példányban megnyitható egy már létező munkafüzet, de létrehozhatók üres munkafüzet, és benne új munkalapok is. 

Egyszerű táblázatos adatok Excel formátumban történő exportálásához nem használnám; ahhoz túl bonyolult.  Oda célszerűbb a ClosedXML, vagy más könyvtár, mely közvetlenül képes  `xlsx` állományt írni / olvasni.  Vállalati környezetben, ha a cél bonyolult makrókkal és diagrammokkal tűzdelt Excel munkafüzetek automatizált kitöltése, van létjogosultsága. 

## Microsoft Excel Object Library

Ez a fejlesztő könyvtár csak a Microsoft Office programcsomag telepítése után érhető el a gépen, de ebből következően bármilyen Excel funkcionalitást könnyedén megvalósít. Az egyik legnagyobb hátránya, hogy viszonylag lassú, és nem alkalmas arra, ha több száz fájlt szeretnénk kigenerálni nagyobb adathalmazokból. Egy egyszerű jelentés elkészítésére azonban tökéletesen megfelel.
